...
const es = {
  ...
  portfolio: {
    ...
    projects: {
      ...
      7: {
        title: "Pronóstico de Demanda de Taxis en NYC",
        description:
          "Pronóstico a una semana de la demanda horaria de taxis amarillos en Nueva York: viajes de la NYC TLC y clima de Open-Meteo cargados en MySQL, ingeniería de características de calendario, rezagos y clima, y modelos de gradient boosting y Prophet evaluados con backtesting contra una línea base estacional, publicado como un reporte en notebook que GitHub Actions reconstruye cada semana",
      },
    },
  },
